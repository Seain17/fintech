    ...
    <div className="screen detail-screen">
      ...
      <div className="detail-content">
        <div className="legal-content">
          <h2>제1조 (목적)</h2>
          <p>
            이 약관은 에이닉(이하 "회사")이 제공하는 서비스의 이용조건 및 절차,
          ...
          <ol>
            <li>"서비스"란 회사가 제공하는 포인트 적립, 출금, 래플 등의 모든 서비스를 말합니다.</li>
            <li>"이용자"란 이 약관에 따라 회사가 제공하는 서비스를 받는 회원을 말합니다.</li>
            <li>"포인트"란 서비스 내에서 적립 및 사용 가능한 가상의 재화를 말합니다.</li>
          </ol>
          ...
          <ol>
            ...
            <li>포인트 출금 서비스</li>
            <li>래플 이벤트 서비스</li>
            <li>제휴사 포인트 전환 서비스</li>
            <li>기타 회사가 정하는 서비스</li>
          </ol>

          <h2>제5조 (포인트)</h2>
          <p>
            ① 포인트는 서비스 내 활동을 통해 적립됩니다.<br />
            ② 포인트의 유효기간은 적립일로부터 2년입니다.<br />
            ③ 회원 탈퇴 시 미사용 포인트는 즉시 소멸됩니다.
          </p>
