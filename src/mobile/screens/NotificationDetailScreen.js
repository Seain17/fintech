...
const notificationDetails = {
  ...
  2: {
    icon: '🎉',
    title: '이번 주 래플 당첨자 발표',
    message: '에어팟 프로 래플 결과가 발표되었습니다.',
    fullMessage: '이번 주 래플 결과가 발표되었어요! 당첨 여부를 확인하고, 새로운 래플에도 참여해보세요.',
    time: '10분 전',
    isNew: true,
    hasButton: true,
  ...
  4: {
    icon: '🎰',
    title: '새로운 래플이 오픈되었어요',
    message: '아이폰 15 Pro 래플이 시작되었습니다. 지금 참여하세요!',
    fullMessage: '가장 핫한 아이폰 15 Pro 래플이 시작되었어요! 100P로 참여하고 행운의 주인공이 되어보세요.',
    time: '3시간 전',
    hasButton: true,
    buttonText: '래플 참여하기',
    link: '/benefits',
  ...
  5: {
    icon: '💡',
    title: '금융 퀴즈 보상 지급',
    message: '퀴즈 정답 보상 30P가 지급되었습니다.',
    fullMessage: '축하합니다! 금융 퀴즈를 맞춰서 30P를 획득하셨어요. 매일 새로운 퀴즈가 업데이트됩니다.',
    time: '어제',
    hasButton: true,
