...
const faqData = [
  {
    ...
    answer: '앱 내 다양한 활동(게임, 미션, 쇼핑 등)을 통해 포인트를 적립할 수 있습니다. 또한 제휴사 포인트를 전환하여 적립할 수도 있습니다.'
  },
  {
    id: 2,
    category: 'point',
    question: '포인트 유효기간이 있나요?',
    answer: '적립된 포인트는 적립일로부터 2년간 유효합니다. 유효기간이 지난 포인트는 자동으로 소멸됩니다.'
  },
  {
    id: 3,
    category: 'withdraw',
  ...
  },
  {
    id: 5,
    category: 'raffle',
    question: '래플 당첨 확률은 어떻게 되나요?',
    answer: '래플 당첨 확률은 각 래플별로 상이하며, 응모 티켓 수에 비례하여 당첨 확률이 높아집니다.'
  },
  {
    id: 6,
    category: 'raffle',
    question: '래플 당첨 상품은 어떻게 받나요?',
    answer: '래플 당첨 시 등록된 휴대폰 번호로 기프티콘이 발송됩니다. 발송된 기프티콘은 해당 브랜드 매장에서 사용 가능합니다.'
  },
  {
    id: 7,
    category: 'account',
  ...
  },
  {
    ...
    answer: '앱 설정 > 회원 탈퇴에서 탈퇴할 수 있습니다. 탈퇴 시 모든 포인트가 소멸되며 복구가 불가능하니 신중히 결정해주세요.'
  },
];
